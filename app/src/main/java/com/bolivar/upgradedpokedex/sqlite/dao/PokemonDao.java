...
public class PokemonDao {
    ...
    public static boolean insertPokemon(String name, String type, String description) {
        // Insert Pokémon
    ...
    public static boolean updatePokemon(int id, String name, String type, String description) {
        // Update Pokémon
        SQLiteDatabase db = AppDbHelper.getInstance().getWritableDatabase();
